...
export default memo(function AssessmentPage() { return (<section className="page-view" id="view-assessment">
<div className="view-header">
<h2>{"Đánh Giá Baseline Day 0 & Bảng Rubric Kiểm Tra Hàng Tuần"}</h2>
<p>{"Mỗi ngày thứ 7 là một bài kiểm tra nghiêm túc kéo dài 4-5 tiếng để đo lường năng lực và điều chỉnh khối lượng học cho tuần tiếp theo."}</p>
</div>
...
<input type="text" className="form-input" placeholder="Ví dụ: A2 / B1 Low" />
</div>
<div className="form-group">
...
<Button variant="unstyled" className="btn-primary" onClick={() => {showToast('Đã lưu kết quả Day 0 Baseline!')}}>{"Lưu Kết Quả Day 0"}</Button>
</div>
</div>
<div className="glass-card">
<h3 className="font-display text-[18px] text-[#fff] mb-[14px]" >{"\n              Bảng Tiêu Chuẩn Điểm Kiểm Tra Tuần (Pass Criteria)\n            "}</h3>
<div className="flex flex-col gap-[10px]" >
<div className="py-[10px] px-[14px] rounded-[8px] [background:rgba(255,255,255,0.03)]" >
